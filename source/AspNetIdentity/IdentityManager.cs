...
namespace Thinktecture.IdentityManager.AspNetIdentity
{
    ...
    //{
    //    public IdentityManager(Microsoft.AspNet.Identity.UserManager<TUser> userManager, IDisposable cleanup = null)
    //        : base(userManager, cleanup)
    //    {
    //    }
    //}

    //public class IdentityManager<TUser, TKey> : IIdentityManagerService, IDisposable
    ...
    //    public IdentityManager(Microsoft.AspNet.Identity.UserManager<TUser, TKey> userManager, IDisposable cleanup = null)
    //    {
